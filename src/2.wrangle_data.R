...
#data_folder <- "/Users/nirwantandukar/Documents/BZea_files/rafael_RTIGER/allelic_count"
...
tsv_files <- tsv_files[85]
# Define the valid chromosome names you want to keep
valid_chromosomes <- paste0("chr", c(8:10))
...
for (file_path in tsv_files) {
  ...
  # Removing empty rows with 0 reads in ref and alt
