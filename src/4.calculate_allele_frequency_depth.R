...
dir <- "/Users/nirwantandukar/Documents/BZea_files/all_het_alt/"
dir <- "/Users/nirwantandukar/Documents/BZea_files/diplo/joint_genotype"
dir <- "/Users/nirwantandukar/Documents/BZea_files/diplo/harder_ref_basic_alt_heter"
...
# List all VCF files
vcf_files <- list.files(dir, pattern="\\.gz", full.names=TRUE)
vcf_files <- vcf_files[c(9:10,2)]
vcf_files <- list.files(dir, pattern="bialleles.vcf", full.names=TRUE)
...
saveRDS(results,"diplo_joint_genotype_with_alt_hetero_indv.RDS")
...
str(results)
x <- results$`/Users/nirwantandukar/Documents/BZea_files/all_het_alt//diplo_all_het_alt_chr1.vcf.gz`$genotype_counts_df
head(x)
sum(x$homo_ref)
sum(x$homo_alt)
sum(x$hetero)
...
y <- readRDS("/Users/nirwantandukar/Documents/BZea_files/diplo.RDS")
mean(y$diplo_chr1$genotype_counts_df$homo_ref_perc)
mean(y$diplo_chr1$genotype_counts_df$homo_alt_perc)
mean(y$diplo_chr1$genotype_counts_df$hetero_perc)
